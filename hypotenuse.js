...
hyp = Math.sqrt((firstSide.value * firstSide.value) + (secondeSide.value * secondeSide.value))
console.log(hyp)
hypOutput.innerText ="The Hypotenuse of Triangle is " + Number(hyp).toFixed(2) + " m"
